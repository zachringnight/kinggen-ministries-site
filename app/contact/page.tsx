        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <FadeIn direction="left">
            <div className="brand-panel p-8">
              <h2 className="text-2xl font-bold font-heading text-text-primary mb-6">{contactContent.formTitle}</h2>
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                ...
                <div>
                  ...
                  <p className="mt-2 text-xs text-text-muted">{contactContent.reasonNote}</p>
                </div>
                ...
                <Button type="submit" variant="primary" fullWidth size="lg" disabled={submitState === "submitting"}>
                  {submitState === "submitting" ? "Sending..." : "Send Message"}
                </Button>

                <p className="text-xs text-text-muted text-center">{contactContent.formNote}</p>
              </form>
            </div>
          </FadeIn>
          ...
          <FadeIn direction="right">
            <div>
              ...
              <div className="mt-8 brand-panel p-6">
                <h3 className="font-bold font-heading text-xl text-text-primary mb-3">
