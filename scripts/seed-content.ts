...
const homeContent = {
  ...
  services: {
    title: 'Our services',
    subtitle:
      'Compassionate, professional counseling rooted in faith and clinical training.',
    items: [
      {
        icon: 'HeartIcon',
        title: 'Pastoral Counseling',
        description:
          'One-on-one sessions that integrate clinical expertise with Gospel truth.',
      },
      {
        icon: 'ShieldIcon',
        title: 'Crisis & Trauma Support',
        description:
          'Compassionate care for women walking through grief, abuse, or life-altering events.',
      },
      {
        icon: 'CrossIcon',
        title: 'Spiritual & Emotional Growth',
        description:
          'Helping women grow in identity, confidence, and Christ-centered resilience.',
      },
    ],
  },
  impact: {
    title: 'Our impact',
    subtitle:
      'Every number represents a life touched by compassion and Gospel-centered care.',
    stats: [
      {
        value: 100,
        suffix: '%',
  ...
  testimonials: {
    ...
    subtitle:
      'Hear from those who have experienced or supported the mission of KingGen Ministries.',
    items: [
      {
        quote:
      ...
      {
        quote:
          'I have seen the impact of this ministry firsthand. Women are met with grace and real help.',
        author: 'Jenna',
      ...
      {
        quote:
          'Supporting KingGen is an investment in lives. Every gift goes directly to care.',
        author: 'Sarah',
...
const aboutContent = {
  hero: {
    ...
    subtitle:
      'A Gospel-centered counseling ministry serving women in need.',
    background: 'about',
  },
  mission: {
    title: 'Mission',
  ...
  speaking: {
    ...
    description:
      'LeeAnn King brings warmth, wisdom, and clinical insight to every speaking engagement.',
    cards: [
      {
        title: 'Churches & Retreats',
        description:
          'Faith-centered messages on hope, healing, and resilience for women.',
      },
      {
        title: 'Podcasts & Interviews',
        description:
          'Conversations on pastoral counseling, faith, and mental health.',
      },
      {
        title: 'Conferences & Panels',
        description:
          'Professional insights on nonprofit leadership and Gospel-centered care.',
      },
    ],
  },
};
...
const servicesContent = {
  hero: {
    title: 'Our Services',
    subtitle:
      'Compassionate, Gospel-centered counseling at no cost to clients.',
    background: 'inner-logo',
  },
  intro: {
    title: 'Counseling support rooted in hope',
    subtitle:
      'Every woman deserves access to care. We offer a range of services designed to meet you where you are.',
  },
  services: [
    {
      icon: 'HeartIcon',
    ...
    },
    {
      ...
      description:
        'Compassionate support for women navigating death, divorce, miscarriage, or other significant loss.',
    },
    {
      icon: 'ShieldIcon',
      title: 'Trauma & Crisis Support',
      description:
        'Trauma-informed care for women walking through abuse, domestic violence, or life-altering events.',
    },
    {
      icon: 'UsersIcon',
      title: 'Relationship & Family Support',
      description:
        'Guidance for navigating relationship pain, family conflict, and rebuilding trust.',
    },
    {
      icon: 'CheckCircleIcon',
    ...
    },
    {
      ...
      description:
        'Equipping women to set healthy boundaries, reclaim identity in Christ, and grow in confidence.',
    },
  ],
  cta: {
    title: 'Ready to take the next step?',
    description:
      'Whether you need support or want to refer someone, we are here to help.',
  },
};
...
const forReferrersContent = {
  hero: {
    title: 'For Referrers',
    subtitle:
      'A clear and compassionate referral pathway for women who need support.',
  },
  who_can_refer: {
    title: 'Who can refer',
    subtitle:
    ...
    items: [
      {
        ...
        description:
          'We protect the privacy of every woman referred to us',
      },
      {
        title: 'Clear communication',
        description:
          'We keep referrers informed as appropriate and permitted',
      },
      {
        title: 'Compassionate care',
        description:
          'Women receive Gospel-centered support at their own pace',
      },
      {
        title: 'Professional standards',
        description:
          'Licensed clinical pastoral counseling with ethical guidelines',
      },
    ],
  },
  how_to_refer: {
    ...
    approach:
      'Submit the referral on her behalf with her awareness and consent.',
    approach_detail:
...
const forGrantWritersContent = {
  hero: {
    ...
    subtitle:
      'Organization and program details for grant applications and funding proposals.',
  },
  organization_facts: [
  ...
  funding_needs: [
    {
      ...
      description:
        'Direct session costs, intake coordination, and follow-up support.',
    },
    {
      area: 'Operations',
      description:
        'Office space, technology, insurance, and administrative costs.',
    },
    {
    ...
    },
    {
      area: 'Technology',
      description:
        'Secure telehealth platform, website, and donor management systems.',
    },
  ],
  tax_exempt: {
...
const getSupportContent = {
  hero: {
    ...
    subtitle:
      'Helpful guidance for women and those supporting a referral.',
  },
  intro:
  ...
  resources: [
    {
      ...
      description:
        'A curated collection of verses for when worry or fear feels overwhelming.',
    ...
    },
    {
      ...
      description:
        'Simple, honest prayers for grief, confusion, anger, and hope.',
    ...
    },
    {
      ...
      description:
        'Guided questions to help you process, reflect, and grow.',
    ...
    },
    {
      ...
      description:
        'Printable cards with Scripture and affirmations to carry with you.',
...
const siteConfigContent = {
  ...
  social: {
    ...
    facebook:
      'https://www.facebook.com/profile.php?id=61573569056063',
  },
};
